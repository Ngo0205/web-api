    ...
    <div class="single">
        <div class="container">
            <div class="single-top">
                <a href="#"><img class="img-responsive" src="{{asset('coffee_break-web/web/images/single-1.jpg')}}" alt=" "></a>
                ...
                <div class="comments heading">
                    ...
                    <div class="media">
                        ...
                        <div class="media-right">
                            <a href="#">
                                <img src="{{asset('coffee_break-web/web/images/si.png')}}" alt=""> </a>
                        </div>
                    </div>
                    <div class="media">
                        <div class="media-left">
                            <a href="#">
                                <img src="{{asset('coffee_break-web/web/images/si.png')}}" alt="">
                            </a>
                        </div>
                        <div class="media-body">
