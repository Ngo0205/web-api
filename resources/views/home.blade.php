        ...
        <div class="container">
            <div class="about-main">
                <div class="col-md-8 about-left">
                    ...
                    <div class="about-two">
                        <a href="single.html"><img src="{{asset('coffee_break-web/web/images/c-1.jpg')}}" alt="" /></a>
                        ...
                        <div class="about-btn">
                            <a href="{{route('description.index')}}">Read More</a>
                        </div>
                        <ul>
                            <li><p>Share : </p></li>
                    ...
                    <div class="about-tre">
                        <div class="a-1">
                            <div class="col-md-6 abt-left">
                                <a href="single.html"><img src="{{asset('coffee_break-web/web/images/c-3.jpg')}}" alt="" /></a>
                                <h6>Find The Most</h6>
                            ...
                            <div class="col-md-6 abt-left">
                                <a href="single.html"><img src="{{asset('coffee_break-web/web/images/c-4.jpg')}}" alt="" /></a>
                                <h6>Find The Most</h6>
                                <h3><a href="single.html">Tasty Coffee</a></h3>
                                <p>Vivamus interdum diam diam, non faucibus tortor consequat vitae. Proin sit amet augue sed massa pellentesque viverra. Suspendisse iaculis purus eget est pretium aliquam ut sed diam.</p>
                                <label>May 29, 2015</label>
                        ...
                        <div class="a-1">
                            <div class="col-md-6 abt-left">
                                <a href="single.html"><img src="{{asset('coffee_break-web/web/images/c-5.jpg')}}" alt="" /></a>
                                <h6>Find The Most</h6>
                                <h3><a href="single.html">Tasty Coffee</a></h3>
                                <p>Vivamus interdum diam diam, non faucibus tortor consequat vitae. Proin sit amet augue sed massa pellentesque viverra. Suspendisse iaculis purus eget est pretium aliquam ut sed diam.</p>
                                <label>May 29, 2015</label>
                            ...
                            <div class="col-md-6 abt-left">
                                <a href="single.html"><img src="{{asset('coffee_break-web/web/images/c-6.jpg')}}" alt="" /></a>
                                <h6>Find The Most</h6>
                                <h3><a href="single.html">Tasty Coffee</a></h3>
                                <p>Vivamus interdum diam diam, non faucibus tortor consequat vitae. Proin sit amet augue sed massa pellentesque viverra. Suspendisse iaculis purus eget est pretium aliquam ut sed diam.</p>
                                <label>May 29, 2015</label>
                        ...
                        <div class="a-1">
                            <div class="col-md-6 abt-left">
                                <a href="single.html"><img src="{{asset('coffee_break-web/web/images/c-7.jpg')}}" alt="" /></a>
                                <h6>Find The Most</h6>
                                <h3><a href="single.html">Tasty Coffee</a></h3>
                                <p>Vivamus interdum diam diam, non faucibus tortor consequat vitae. Proin sit amet augue sed massa pellentesque viverra. Suspendisse iaculis purus eget est pretium aliquam ut sed diam.</p>
                                <label>May 29, 2015</label>
                            ...
                            <div class="col-md-6 abt-left">
                                <a href="single.html"><img src="{{asset('coffee_break-web/web/images/c-8.jpg')}}" alt="" /></a>
                                <h6>Find The Most</h6>
                                <h3><a href="single.html">Tasty Coffee</a></h3>
                                <p>Vivamus interdum diam diam, non faucibus tortor consequat vitae. Proin sit amet augue sed massa pellentesque viverra. Suspendisse iaculis purus eget est pretium aliquam ut sed diam.</p>
                                <label>May 29, 2015</label>
                ...
                <div class="col-md-4 about-right heading">
                    <div class="abt-1">
                        <h3>ABOUT US</h3>
                        <div class="abt-one">
                            <img src="{{asset('coffee_break-web/web/images/c-2.jpg')}}" alt="" />
                    ...
                    <div class="abt-2">
                        ...
                        <div class="might-grid">
                            <div class="grid-might">
                                <a href="single.html"><img src="{{asset('coffee_break-web/web/images/c-12.jpg')}}" class="img-responsive" alt=""> </a>
                            </div>
                            <div class="might-top">
                        ...
                        <div class="might-grid">
                            <div class="grid-might">
                                <a href="single.html"><img src="{{asset('coffee_break-web/web/images/c-10.jpg')}}" class="img-responsive" alt=""> </a>
                            </div>
                            <div class="might-top">
                                <h4><a href="single.html">Duis consectetur gravida</a></h4>
                                <p> Nullam non magna lobortis, faucibus erat eu, consequat justo. Suspendisse commodo nibh odio.</p>
                        ...
                        <div class="might-grid">
                            <div class="grid-might">
                                <a href="single.html"><img src="{{asset('coffee_break-web/web/images/c-11.jpg')}}" class="img-responsive" alt=""> </a>
                            </div>
                            <div class="might-top">
                                <h4><a href="single.html">Duis consectetur gravida</a></h4>
                                <p> Nullam non magna lobortis, faucibus erat eu, consequat justo. Suspendisse commodo nibh odio.</p>
